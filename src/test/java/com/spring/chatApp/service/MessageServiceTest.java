...
public class MessageServiceTest {
    ...
    Message message = new Message(UUID.fromString("7e4c2f7c-0711-4d34-ab0d-2b913af4207e"), "aaaaaaa", LocalDateTime.of(2024, 8, 22, 11, 35, 59), null, UUID.fromString("da6cc511-51b7-43e4-8cf0-e35bfc3b2d22"), UUID.fromString("3ae01670-78ee-46f0-bba0-8a86081220bc"));
    ...
    void twoWayChat() {
        ...
        UUID userId1 = mockUser1.getId();
        UUID userId2 = mockUser2.getId();
        when(messageRepository.findBySenderIdAndRecipientId(userId1, userId2, userId2, userId1)).thenReturn(messages);

        assertThat(messageService.twoWayChat("user1", "user").get(0).getText()).isEqualTo(messages.get(0).getText());
    }
